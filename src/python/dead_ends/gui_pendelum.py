...
from src.wave import solve_theta
from src.algo import OpticalFlowLucasKanade
...
class WaveGUI:
    ...
    def update_plot(self, factor=100):
        ...
        for _ in range(factor):
            self.theta, self.theta_dot, dt = solve_theta(self.theta, self.theta_dot, gain=self.gain)
            self.t += dt
